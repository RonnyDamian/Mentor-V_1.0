            ...
            <div class="modal-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped active" role="progressbar"
                         aria-valuenow="0" aria-valuemin="20" aria-valuemax="20" style="width:0%">
                        20%
                    </div>
                </div>
            </div>
...
<script>
    $( document ).ready(function() {
        ...
        setInterval(function(){
                while(progressNumber<=20){
                    progressBar.css('width', progressNumber + '%');
                    progressBar.attr('aria-valuenow', progressNumber);
                    progressNumber++;
                }
            $('#messagge').html("¡Muy buen comienzo! ¡Vamos por más! 💪");
        },1000);
    });

    $('#continue').on('click', function () {
        setTimeout("location.href='questions2.php' ", 100);
    })
</script>
<script>
    $('#myModal').modal({
