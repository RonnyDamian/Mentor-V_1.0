            ...
            <div class="modal-body">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped active" role="progressbar"
                         aria-valuenow="20" aria-valuemin="20" aria-valuemax="20" style="  width:20%;">
                        20%
                    </div>
                </div>
            </div>
...
<script>
    $( document ).ready(function() {
        ...
        setInterval(function(){
                while(progressNumber<=40){
                    progressBar.css('width', progressNumber + '%');
                    progressBar.attr('aria-valuenow', progressNumber);
                    progressNumber++;
                }
            $('#messagge').html("¡Bien contestado! ¡No te detengas! 😉👍");
                $(".progress-bar").html('40%');
        },1000);
    });

    $('#continue').on('click', function () {
        setTimeout("location.href='questions3.php' ", 100);
    })
</script>
<script>
    $('#myModal').modal({
